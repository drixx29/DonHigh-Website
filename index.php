    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: DonHigh Outdoors.<br>
            022 ME-A Ilayang Iyam, Maharlika Highway, Lucena City.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="tel:0123456789">0961-7523-158</a>
            </div>
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">august.181993@yahoo.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> DonHigh Outdoors&trade;
          </div>

          <div class="developer">
            Developed by Hendrix C. Pinili
          </div>

          <div class="designby">
            Design by Hendrix C. Pinili
          </div>
